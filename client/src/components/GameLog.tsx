...
export const GameLog = ({ entries }: GameLogProps): JSX.Element => {
  ...
  return (
    <div className="flex max-h-[30vh] flex-col rounded-xl border border-slate-800 bg-slate-900/80 p-4">
      <div className="text-xs font-semibold uppercase tracking-wide text-slate-400">Game Log</div>
      <div className="mt-3 flex flex-1 flex-col gap-2 overflow-y-auto text-sm text-slate-200">
